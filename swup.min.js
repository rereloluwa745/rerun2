(function e(t, n) {
        ...
        var L = function() {
            ...
            i(e, [{
                ...
                value: function e() {
                    ...
                    var n = (0,
                    j.getDataFromHtml)(document.documentElement.outerHTML, this.options.containers);
                    n.url = n.responseURL = (0,
                    j.getCurrentUrl)();
                    if (this.options.cache) {
                        this.cache.cacheUrl(n)
                    }
                    (0,
                    j.markSwupElements)(document.documentElement, this.options.containers);
                ...
                value: function e() {
                    ...
                    (0,
                    O.queryAll)("[data-swup]").forEach(function(e) {
        ...
        var a = function e(t, n) {
            ...
            var s = function e(t) {
                if (a.querySelector(n[t]) == null) {
                    ...
                    (0,
                    i.queryAll)(n[t]).forEach(function(e, r) {
                        (0,
                        i.queryAll)(n[t], a)[r].setAttribute("data-swup", o.length);
                        o.push((0,
                        i.queryAll)(n[t], a)[r].outerHTML)
                    })
                }
            };
            ...
            var a = function e(a) {
                if (t.querySelector(n[a]) == null) {
                    ...
                    r.queryAll)(n[a]).forEach(function(e, o) {
                        (0,
                        r.queryAll)(n[a], t)[o].setAttribute("data-swup", i);
                        i++
                    })
                }
            };
    ...
    , function(e, t, n) {
        ...
        var a = function e() {
            var t = [];
            var n = (0,
            r.queryAll)(this.options.animationSelector);
            n.forEach(function(e) {
                var n = new Promise(function(t) {
                    e.addEventListener((0,
                    i.transitionEnd)(), function(n) {
                        if (e == n.target) {
                            t()
                        }
                    })
    ...
    , function(e, t, n) {
        ...
        var i = function e(t) {
            ...
            var i = (0,
            r.getDataFromHtml)(n, this.options.containers);
            if (i) {
